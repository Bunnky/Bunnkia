...
//========================================================
void Rogue::initVariables()
{
	this->initAttack = false;
	this->attacking = false;
	this->weapon = new Sword(1, 2, 5, 60, 20, "gamedata/Resources/Images/Sprites/Rogue/sword4.png");
	this->weapon->generate(1, 6001);
	this->damageTimerMax = 500;
}

void Rogue::initComponents()
{
}

void Rogue::initAnimations()
{
	...
	//========================================================
	//CHANGE THESE IF WE WANT TO DO DIRECTIONAL Rogue SPRITES
	//========================================================
	//this->animationComponent->addAnimation("WALK_DOWN", 6.f, 0, 1, 3, 1, 32, 32);
	//this->animationComponent->addAnimation("WALK_LEFT", 6.f, 0, 1, 3, 1, 32, 32);
...
//========================================================
Rogue::Rogue(float x, float y, sf::Texture& texture_sheet)
{
	this->initVariables();
...
//Accessors
//========================================================
AttributeComponent* Rogue::getAttributeComponent()
{
	return this->attributeComponent;
}

Weapon* Rogue::getWeapon() const
{
	return this->weapon;
}

const std::string Rogue::toStringCharacterTab() const
{
	std::stringstream ss;
...
const bool& Rogue::getInitAttack() const
{
	return this->initAttack;
}

const bool Rogue::getDamageTimer()
{
...
const unsigned Rogue::getDamage() const
{
	return rand() % (
...
void Rogue::setInitAttack(const bool initAttack)
{
...
//Functions
//========================================================
void Rogue::loseHP(const int hp)
{
	this->attributeComponent->loseHP(hp);
}

void Rogue::gainHP(const int hp)
{
	this->attributeComponent->gainHP(hp);
}

void Rogue::loseEXP(const int exp)
{
	this->attributeComponent->gainExp(exp);
}

void Rogue::gainEXP(const int exp)
{
	this->attributeComponent->gainExp(exp);
}

void Rogue::updateAnimation(const float& dt)
{
	if (this->attacking)
	{
	}
...
void Rogue::update(const float& dt, sf::Vector2f& mouse_pos_view, const sf::View& view)
{
...
void Rogue::render(sf::RenderTarget& target, sf::Shader* shader, const sf::Vector2f light_position, const bool show_hitbox)
{
	if (shader)
	{
