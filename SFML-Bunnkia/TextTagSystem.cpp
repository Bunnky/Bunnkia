...
{
	this->tagTemplates[DEFAULT_TAG] = new TextTag(this->font, "", 100.f, 100.f, 0.f, -1.f, sf::Color::White, .5f, sf::Color::Red, 1, 16, 100.f, true, 100.f, 300.f, 2);

	this->tagTemplates[NEGATIVE_TAG] = new TextTag(this->font, "", 100.f, 100.f, 0.f, 1.f, sf::Color::Red, .5f, sf::Color::Red, 0, 12, 100.f, true, 150.f, 100.f, 1);

	this->tagTemplates[EXPERIENCE_TAG] = new TextTag(this->font, "", 100.f, 100.f, 0.f, -1.f, sf::Color::White, .5f, sf::Color::Blue, 2, 20, 200.f, false, 1000.f, 200.f, 2);
